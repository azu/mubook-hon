    ...
    27: function (e, t) {
        Bibi.x({
            ...
            E.bind("bibi:postprocessed-item", function (n) {
                "prevent" == e["select-elements"] &&
                    t.forEach(function (e) {
                        ["user-select", "user-drag"].forEach(function (t) {
                            n.Body.style[e + t] = "none";
                        });
                    }),
                    "prevent" == e["save-images"] &&
                        sML.forEach(n.Body.querySelectorAll("img, svg, image"))(function (e) {
                            t.forEach(function (t) {
                                ...
                                (e.draggable = !1),
                                e.addEventListener("contextmenu", O.preventDefault);
                        }),
                    "prevent" == e["use-contextmenu"] &&
                        n.contentDocument.addEventListener("contextmenu", O.preventDefault);
            });
        });
    }
});
