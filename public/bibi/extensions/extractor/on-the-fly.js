 ...
 */ !(function (t) {
    ...
    23: function (t, e, r) {
        var n = new (r(24))({
            url: S.book,
            worker: document.currentScript.src.replace(
                /\.js$/,
                ".bibi-zip-loader.worker" + (sML.UA.Trident ? ".alt" : "") + ".js"
            )
        });
        Bibi.x({
        ...
        (function (t) {
            ...
            window,
                        ...
                        function (t, e, r) {
                            ...
                            r.r(e),
                                ...
                                (function (t) {
                                    (t.INIT = "INIT"),
                                        (t.GET_DATA = "GET_DATA"),
                                        (t.ABORT_DATA = "ABORT_DATA"),
                                        (t.UPDATE_STATE = "UPDATE_STATE");
                                })(o || (o = {}));
                            var c = (function () {
                                function t(e) {
                                    var r = this;
                                    !(function (t, e) {
                                        ...
                                        (this.params = e),
                                        u(this, "resolvers", void 0),
                                        u(this, "worker", void 0),
                                        u(this, "onFallback", void 0),
                                        u(this, "onmessage", function (t) {
                                            var e = t.data,
                                                n = e.type;
                                    ...
                                    var n = i();
                                    (this.resolvers = { init: n, getData: {} }),
                                        (this.worker = new Worker(e.worker || "lszlw.js")),
                                        (this.worker.onmessage = this.onmessage),
                                        this.worker.postMessage({ type: o.INIT, payload: e });
                                }
                                var e, r;
                                return (
                                    (e = t),
                                    (r = [
                                        ...
                                        },
                                        {
                                            ...
                                            value: function (t) {
                                                ...
                                                var n = i();
                                                return (
                                                    (this.resolvers.getData[t] = n),
                                                    this.worker.postMessage({ type: o.GET_DATA, payload: t }),
                                                    n.then(
                                                        function () {
                                        ...
                                        },
                                        {
                                            key: "abort",
                                            value: function (t) {
                                                this.resolvers.getData[t] &&
                                                    this.worker.postMessage({ type: o.ABORT_DATA, payload: t });
                                            }
                                        }
                                    ]) && a(e.prototype, r),
                                    t
                            ...
                            var v = (function () {
                                function t(e) {
                                    ...
                                    !(function (t, e) {
                                        ...
                                        p(this, "url", void 0),
                                        p(this, "debug", void 0),
                                        p(this, "setupWorkers", void 0),
                                        p(this, "prefetching", void 0),
                                        p(this, "prefetchAll", function () {
                                                            ...
                                                            for (;;)
                                                                switch ((t.prev = t.next)) {
                                                                    ...
                                                                    case 8:
                                                                        ...
                                                                        return (
                                                                            (c = u.value), (t.next = 12), r.getBuffer(c)
                                                                        );
                                                                    case 12:
                                                                        (n = !0), (t.next = 8);
                                                                        break;
                                                    ...
                                                    return regeneratorRuntime.wrap(function (t) {
                                                        for (;;)
                                                            switch ((t.prev = t.next)) {
                                                                case 0:
                                                                    return (
                                                                        r.throwIfAbort(), (t.next = 3), r.setupWorkers
                                                                    );
                                                                case 3:
                                                                    return (e = t.sent), (t.next = 6), e[0].getState();
                                                                case 6:
                                                                    return (
                                                                        (n = t.sent), t.abrupt("return", n.entryNames)
                                                                    );
                                                                case 8:
                                                                case "end":
                                                                    return t.stop();
                                                ...
                                                return regeneratorRuntime.wrap(function (t) {
                                                    for (;;)
                                                        switch ((t.prev = t.next)) {
                                                            ...
                                                            case 6:
                                                                for (
                                                                    n.onFallback = function () {
                                                                        return r.fallback(n);
                                                                    },
                                                                        o = [n],
                                                                        i =
                                                                            (e.multiply && Math.max(e.multiply, 1)) ||
                                                                            4,
                                                                        a = function (t) {
                                                                            var e = new c({
                                                                                url: r.url,
                                ...
                                return (
                                    ...
                                    (r = [
                                        ...
                                        { key: "throwIfAbort", value: function () {} },
                                        {
                                            key: "fallback",
                                            value: function (t) {
                ...
                "object" == a(e) && "object" == a(t)
                    ? (t.exports = i())
                    : ((n = []), void 0 === (o = "function" == typeof (r = i) ? r.apply(e, n) : r) || (t.exports = o));
        }.call(this, r(25)(t)));
    },
    25: function (t, e) {
