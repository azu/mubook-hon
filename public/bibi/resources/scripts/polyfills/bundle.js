 ...
 */ !(function (t) {
    ...
    function (t, e, n) {
        ...
        function u(t, e) {
            ...
            if ("utf-8" !== (t = void 0 !== t ? String(t).toLowerCase() : "utf-8"))
        ...
        u.prototype = {
            decode: function (t, e) {
                var n;
                (n =
                    "object" === r(t) && t instanceof ArrayBuffer
                        ? new Uint8Array(t)
                        : "object" === r(t) && "buffer" in t && t.buffer instanceof ArrayBuffer
                        ? new Uint8Array(t.buffer, t.byteOffset, t.byteLength)
                        : new Uint8Array(0)),
                    (e = i(e)),
                    this._streaming || ((this._decoder = new a({ fatal: this._fatal })), (this._BOMseen = !1)),
                    (this._streaming = Boolean(e.stream));
                for (var o, c = new s(n), u = []; !c.endOfStream() && -1 !== (o = this._decoder.handler(c, c.read())); )
                ...
                return (
                    u.length &&
                        (-1 === ["utf-8"].indexOf(this.encoding) ||
                            this._ignoreBOM ||
                            this._BOMseen ||
                            (65279 === u[0] ? ((this._BOMseen = !0), u.shift()) : (this._BOMseen = !0))),
                    (function (t) {
                        for (var e = "", n = 0; n < t.length; ++n) {
                            var r = t[n];
                            r <= 65535
                                ? (e += String.fromCharCode(r))
                                : ((r -= 65536), (e += String.fromCharCode(55296 + (r >> 10), 56320 + (1023 & r))));
                        }
                        return e;
                    })(u)
                );
                            ...
                            if (n && -1 == this._monitoringDocuments.indexOf(e)) {
                                ...
                                if (
                                    (this.POLL_INTERVAL
                                        ...
                                        : (u(n, "resize", r, !0),
                                          ...
                                          this.USE_MUTATION_OBSERVER &&
                                              ...
                                              (s = new n.MutationObserver(r)).observe(e, {
                                                  attributes: !0,
                                                  childList: !0,
                                                  characterData: !0,
                                                  subtree: !0
                                    ...
                                    this._monitoringUnsubscribes.push(function () {
                                        var t = e.defaultView;
                                        t && (o && t.clearInterval(o), a(t, "resize", r, !0)),
                                            a(e, "scroll", r, !0),
                                            s && s.disconnect();
                                    }),
                        ...
                        (c.prototype._checkForIntersections = function () {
                            if (this.root || !r || o) {
                                ...
                                this._observationTargets.forEach(function (n) {
                                    ...
                                    u
                                        ? t && c
                                            ? this._hasCrossedThreshold(u, l) && this._queuedEntries.push(l)
                                ...
                                for (var s, c, u, a, l, p, m, y, g = n, v = d(e), b = !1; !b && v; ) {
                                    ...
                                    if (
                                        (w &&
                                            ...
                                            (a = Math.min(s.bottom, c.bottom)),
                                            (l = Math.max(s.left, c.left)),
                ...
                (function (t) {
                    ...
                    if ("Element" in t) {
                        ...
                        if (
                            ...
                            var f = { get: a, enumerable: !0, configurable: !0 };
                            try {
            ...
            (u = function () {
                ...
                function u() {
                    for (var t = 0; t < this.chain.length; t++)
                        f(this, 1 === this.state ? this.chain[t].success : this.chain[t].failure, this.chain[t]);
                    this.chain.length = 0;
                }
                function f(t, e, n) {
                    var r, o;
                    try {
                        !1 === e
                            ? n.reject(t.msg)
                            : (r = !0 === e ? t.msg : e.call(void 0, t.msg)) === n.promise
                ...
                return (
                    ...
                    t(y, "resolve", function (t) {
                        return t && "object" == a(t) && 1 === t.__NPO__
                            ? t
                ...
                ((c = void 0 !== r ? r : this)[(s = "Promise")] = c[s] || u()),
                t.exports
                    ? (t.exports = c[s])
                    : void 0 ===
                          (i = function () {
                    ...
                    (function () {
                        var i = function t(n) {
                                ...
                                if ("undefined" === r);
                                    ...
                                    else for (var c in n) n.hasOwnProperty(c) && this.append(c, n[c]);
                                }
                            },
                            s = i.prototype;
                        ...
                        ((function () {
                            ...
                            (r = (n = function (e, n) {
                                ...
                                if (
                                    ((s.type = "url"),
                                    (s.value = e),
                                    ":" === i.protocol || !/:/.test(i.href) || (!s.checkValidity() && !n))
                                )
                                ...
                                Object.defineProperty(this, "_updateSearchParams", {
                                    ...
                                    value: function () {
                                        this.search !== l &&
                                            ((l = this.search),
                                            a && ((u = !1), this.searchParams._fromString(this.search), (u = !0)));
                                    }
                                });
                            }).prototype),
