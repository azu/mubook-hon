 ...
 */ !(function (e) {
    ...
    1: function (e, t, r) {
        ...
        function s(e, t) {
            ...
            if ("utf-8" !== (e = void 0 !== e ? String(e).toLowerCase() : "utf-8"))
        ...
        s.prototype = {
            decode: function (e, t) {
                var r;
                (r =
                    "object" === n(e) && e instanceof ArrayBuffer
                        ? new Uint8Array(e)
                        : "object" === n(e) && "buffer" in e && e.buffer instanceof ArrayBuffer
                        ? new Uint8Array(e.buffer, e.byteOffset, e.byteLength)
                        : new Uint8Array(0)),
                    (t = i(t)),
                    this._streaming || ((this._decoder = new a({ fatal: this._fatal })), (this._BOMseen = !1)),
                    (this._streaming = Boolean(t.stream));
                for (var o, u = new f(r), s = []; !u.endOfStream() && -1 !== (o = this._decoder.handler(u, u.read())); )
