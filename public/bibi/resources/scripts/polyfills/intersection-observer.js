                            ...
                            if (n && -1 == this._monitoringDocuments.indexOf(e)) {
                                ...
                                if (
                                    ...
                                    this._monitoringUnsubscribes.push(function () {
                                        var t = e.defaultView;
                                        t && (i && t.clearInterval(i), c(t, "resize", o, !0)),
                                            c(e, "scroll", o, !0),
                                            s && s.disconnect();
                                    }),
                        ...
                        (u.prototype._checkForIntersections = function () {
                            if (this.root || !o || i) {
                                ...
                                this._observationTargets.forEach(function (n) {
                                    ...
                                    h
                                        ? t && u
                                            ? this._hasCrossedThreshold(h, a) && this._queuedEntries.push(a)
                                            : h && h.isIntersecting && this._queuedEntries.push(a)
                                ...
                                for (var s, u, h, c, a, p, g, m, b = n, v = d(e), _ = !1; !_ && v; ) {
                                    ...
                                    if (
                                        (y &&
                                            ...
                                            (g = void 0),
                                            (m = void 0),
                                            (h = Math.max(s.top, u.top)),
                                            (c = Math.min(s.bottom, u.bottom)),
                                            (a = Math.max(s.left, u.left)),
