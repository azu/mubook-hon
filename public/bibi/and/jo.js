            ...
            if (!window["bibi:jo"]) {
                ...
                (e.Bibi = function () {
                    ...
                    (e.callBibi = function (n) {
                            ...
                            if (n instanceof HTMLElement) {
                                if (/^iframe$/i.test(n.tagName)) {
                                    ...
                                    (u = n),
                                        ...
                                        (o = u.getAttribute("data-bibi-id")) && c.setAttribute("id", o),
                                        (r = u.getAttribute("data-bibi-style")) && c.setAttribute("style", r);
                                }
                                ...
                                if (n && "object" == i(n)) {
                                    ...
                                    (u = e.create("a", { href: n["bibi-href"] })), (c = e.create("iframe")), (s = c);
                                }
                        ...
                        var b,
                            p =
                                (u.Bibi =
                                c.Bibi =
                                    { Jo: e, Anchor: u, Frame: c, Receiver: s, Index: e.Bibis.length, Status: "" });
                        return (
                            ...
                            (p.dispatch = function (e) {
                                ...
                                return !!t.test(e) && s.dispatchEvent(new CustomEvent(e, { detail: n }));
                            }),
                            ...
                            (p.post = function (e, n) {
                                return (
                                    !!t.test(e) &&
                                    c.contentWindow.postMessage('{ "'.concat(e, '" : "').concat(n, '" }'), u.origin)
                                );
                            }),
                            ...
                            e.TrustworthyOrigins.includes(u.origin) || e.TrustworthyOrigins.push(u.origin),
                            (u.href +=
                                (/#/.test(u.href) ? "&" : "#") +
                                ...
                                [
                                    ...
                                    var t =
                                        "" +
                                        (n.ownerDocument ? n.getAttribute("data-bibi-" + e) || "" : n["bibi-" + e]);
                                    t &&
                                        (function () {
                                            switch (e) {
                                                case "p":
                        ...
                        function (t) {
                            ...
                            try {
                                if (
                                    ...
                                    "object" != ("undefined" == typeof Data ? "undefined" : i(Data)) || !Data)
                                )
                                    return !1;
                    ...
                    (e.Fragments = function () {
                        return (
                            ...
                            (this.make = function () {
                                ...
                                for (var t = [], n = this.FragmentKeys.length, i = 0; i < n; i++)
                                    t.push(
                                        ""
                                            .concat(this.FragmentKeys[i], "=")
                                            .concat(e.encode(this.FragmentKeysAndValues[this.FragmentKeys[i]]))
                                    );
                    ...
                    (e.judge = function (t, n) {
                        return (
                            t && "string" == typeof t && n && "string" == typeof n && e.TrustworthyOrigins.includes(n)
                        );
                    }),
                    ...
                    (e.dispatch = function (n) {
                        ...
                        return !!t.test(n) && document.dispatchEvent(new CustomEvent(n, { detail: i }));
                    }),
                    Array.prototype.includes ||
                        (Array.prototype.includes = function (e) {
                            for (var t = this.length, n = 0; n < t; n++) if (this[n] == e) return !0;
                            return !1;
                        }),
                    (!window.CustomEvent ||
                        ("function" != typeof window.CustomEvent &&
                            -1 === window.CustomEvent.toString().indexOf("CustomEventConstructor"))) &&
